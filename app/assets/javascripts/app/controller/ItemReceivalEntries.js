Ext.define('AM.controller.ItemReceivalEntries', {
  extend: 'Ext.app.Controller',

  stores: ['ItemReceivalEntries', 'ItemReceivals'],
  models: ['ItemReceivalEntry'],

  views: [
    'factory.itemreceivalentry.List',
    'factory.itemreceivalentry.Form',
  ...
  init: function() {
    this.control({
      'itemreceivalentrylist': {
        itemdblclick: this.editObject,
        selectionchange: this.selectionChange ,
				afterrender : this.loadObjectList
      },
      'itemreceivalentryform button[action=save]': {
        click: this.updateObject
      },
      'itemreceivalentrylist button[action=addObject]': {
        click: this.addObject
      },
      'itemreceivalentrylist button[action=editObject]': {
        click: this.editObject
      },
      'itemreceivalentrylist button[action=deleteObject]': {
        click: this.deleteObject
      },

			// monitor parent(item_receival) update
			'itemreceivallist' : {
	...
	reloadStore : function(record){
		...
		var store = this.getItemReceivalEntriesStore();
  ...
  addObject: function() {
    ...
    var view = Ext.widget('itemreceivalentryform', {
			parentRecord : record 
		});
  ...
  updateObject: function(button) {
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			record.save({
				params : {
					item_receival_id : parentRecord.get('id')
				},
			...
			var newObject = new AM.model.ItemReceivalEntry( values ) ;
    ...
    var record = this.getList().getSelectedObject();
		if(!record){return;}
		var parent_id = record.get('item_receival_id');
		var list  = this.getList();
