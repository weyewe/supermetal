Ext.define('AM.controller.PostProductionResults', {
  extend: 'Ext.app.Controller',

  stores: ['PostProductionResults', 'TemplateSalesItems'],
  models: ['PostProductionResult'],

  views: [
    'factory.postproductionresult.List',
    'factory.postproductionresult.Form',
  ...
  init: function() {
    this.control({
      ...
      'postproductionresultform button[action=save]': {
        click: this.updateObject
      },
      'postproductionresultlist button[action=addObject]': {
        click: this.addObject
      },
      'postproductionresultlist button[action=editObject]': {
        click: this.editObject
      },
      'postproductionresultlist button[action=deleteObject]': {
        click: this.deleteObject
      },
			'postproductionresultlist button[action=confirmObject]': {
  ...
  addObject: function() {
    ...
    var view = Ext.widget('postproductionresultform');
  ...
  updateObject: function(button) {
    ...
    var form = win.down('form');
		...
		var parentRecord = this.getTemplateSalesItemList().getSelectedObject();
    var store = this.getPostProductionResultsStore();
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			var me  = this; 
			var newObject = new AM.model.PostProductionResult( values ) ;
...
// to do refresh programmatically
	...
	confirmObject: function(){
		...
		Ext.Ajax.request({
		    url: 'api/confirm_post_production_result',
		    method: 'POST',
		    params: {
					id : record.get('id')
		    },
