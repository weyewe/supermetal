Ext.define('AM.controller.ProductionRepairResults', {
  extend: 'Ext.app.Controller',

  stores: ['ProductionRepairResults', 'TemplateSalesItems'],
  models: ['ProductionRepairResult'],

  views: [
    'factory.productionrepairresult.List',
    'factory.productionrepairresult.Form',
  ...
  init: function() {
    this.control({
      ...
      'productionrepairresultform button[action=save]': {
        click: this.updateObject
      },
      'productionrepairresultlist button[action=addObject]': {
        click: this.addObject
      },
      'productionrepairresultlist button[action=editObject]': {
        click: this.editObject
      },
      'productionrepairresultlist button[action=deleteObject]': {
        click: this.deleteObject
      },
			'productionrepairresultlist button[action=confirmObject]': {
  ...
  addObject: function() {
    ...
    var view = Ext.widget('productionrepairresultform');
  ...
  updateObject: function(button) {
    ...
    var form = win.down('form');
		...
		var parentRecord = this.getTemplateSalesItemList().getSelectedObject();
    var store = this.getProductionRepairResultsStore();
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			var me  = this; 
			var newObject = new AM.model.ProductionRepairResult( values ) ;
...
// to do refresh programmatically
	...
	confirmObject: function(){
		...
		Ext.Ajax.request({
		    url: 'api/confirm_production_repair_result',
		    method: 'POST',
		    params: {
					id : record.get('id')
		    },
