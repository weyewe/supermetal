Ext.define('AM.view.factory.productionresult.Form', {
  extend: 'Ext.window.Window',
  alias : 'widget.productionresultform',
      ...
      items: [
	        ...
	        fieldLabel: 'template_sales_item_id'
				...
				},
				{
					...
					items : [ 
						{
							fieldLabel: 'Jumlah Perbaiki',
							name: 'repairable_quantity' ,
							xtype : 'textfield'
						},
						
						{
							fieldLabel: 'Berat Perbaiki',
							name: 'repairable_weight' ,
							xtype : 'textfield'
						},
						{
							fieldLabel: 'Berat Tap Perbaiki',
							name: 'repairable_tap_weight' ,
							xtype : 'textfield'
						}
					]
				},
