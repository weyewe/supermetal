	...
	itemInfo : function(){
		var remoteJsonStore = Ext.create(Ext.data.JsonStore, {
			...
			fields	: [
				...
				{
					name : 'delivery_entry_item_condition',
					mapping : 'code'
				},
				{
					name : 'delivery_entry_entry_case',
					mapping : 'code'
				},
				{
					name : 'sales_item_code',
					mapping : 'sales_item_code'
				},
				{
					name : 'sales_item_name',
					mapping : 'sales_item_name'
				},
				{
					name : 'sales_item_id',
					mapping : 'sales_item_id'
				}
			],
			proxy  	: {
				type : 'ajax',
				url : 'api/search_delivery_entries',
				reader : {
					type : 'json',
					root : 'records', 
					totalProperty  : 'total'
