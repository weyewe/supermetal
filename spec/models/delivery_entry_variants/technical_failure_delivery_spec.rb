  ...
  context "confirming item receival" do
    ...
    context "do the post production work with broken quantity" do
      ...
      it 'should increase the pending delivery bad source by 1 ' do
        ...
        context "sending the Technical failure delivery" do
          before(:each) do
          ...
          it 'should not allow delivery of bad source if the item condition is production' do
            ...
            @delivery_entry = DeliveryEntry.create_delivery_entry( @admin, @delivery, {
                ...
                :entry_case => DELIVERY_ENTRY_CASE[:technical_failure_post_production],  # pricing level 
          ...
          context "confirming delivery" do
            before(:each) do
              ...
              @initial_pending_delivery_broken_quantity = @template_sales_item.pending_delivery_broken_quantity
            ...
            it 'should reduce the number of broken item (because we are  sending broken source)' do
              @final_pending_delivery_broken_quantity = @template_sales_item.pending_delivery_broken_quantity
              diff = @initial_pending_delivery_broken_quantity - @final_pending_delivery_broken_quantity
